"""
Django settings for ig_song_finder project.
"""
import os
...
ROOT_URLCONF = 'ig_song_finder.urls'
...
WSGI_APPLICATION = 'ig_song_finder.wsgi.application'

# Database - PostgreSQL
DATABASE_URL = os.getenv('DATABASE_URL', 'postgres://songfinder_user:password@localhost:5432/songfinder')
...
# Audio Processing
AUDIO_SNIPPET_DURATION = 10  # seconds
